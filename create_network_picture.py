...
# you don't need to use this file unless you want to use your own old_gbg_tramnet.svg
...
# rename the resulting file to old_gbg_tramnet.svg when you have your final version

from lab3.tram.utils.trams import readTramNetwork
import graphviz
import json

MY_GBG_SVG = 'my_gbg_tramnet.svg'  # the output SVG file
MY_TRAMNETWORK_JSON = '/Users/andyvungoc/PycharmProjects/DAT515/lab3/static/tramnetwork.json'  # JSON file from lab1
TRAM_URL_FILE = '/Users/andyvungoc/PycharmProjects/DAT515/lab3/static/tram-url.json'  # given in lab3/files, replace with your own in bonus 2
